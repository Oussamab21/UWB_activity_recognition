...
LOSO_run=['LOSO1','LOSO2','LOSO3','LOSO4','LOSO5','LOSO6','LOSO7','LOSO8','LOSO9','LOSO10','LOSO11']


#LOSO_run=['LOSO4','LOSO5','LOSO6','LOSO7','LOSO8','LOSO9','LOSO10','LOSO11']

#LOSO_run=['LOSO9','LOSO10','LOSO11']

#LOSO_run=['LOSO7','LOSO8']
...
#dataset_dir_train ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/dataset_LOSO4/train_dataset_LOSO4_5sec_overlapping0.9/"


#dataset_dir_val ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/dataset_LOSO4/val_dataset_LOSO4_5sec_overlapping0.9/"


#dataset_dir_test ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/dataset_LOSO4/test_dataset_LOSO4_5sec_overlapping0.9/"


###########################################               ############################################     ###########

#dataset_dir_train_mat ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/LOSO4/5sec_overlapping0.9/train/run"+str(run)+"/"


#dataset_dir_val_mat ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/LOSO4/5sec_overlapping0.9/val/run"+str(run)+"/"


#dataset_dir_test_mat ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/LOSO4/5sec_overlapping0.9/test/run"+str(run)+"/"


#performence_file='C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/LOSO4/5sec_overlapping0.9/'+"performances_UWB_classification1_LOSO4_5s_overlapping0.9_run"+str(run)+".txt"


#train_report_file=dataset_dir_train_mat+'train_report_UWB_classification1_LOSO4_5s_overlapping0.9_run'+str(run)+'.txt'

#val_report_file=dataset_dir_val_mat+'val_report_UWB_classification1_LOSO4_5s_overlapping0.9_run'+str(run)+'.txt'

#test_report_file=dataset_dir_test_mat+'test_report_UWB_classification1_LOSO4_5s_overlapping0.9_run'+str(run)+'.txt'
...
def train_plot_confusion_matrix(cfm,epoch):
    ...
    #print('dataset train mat path ',str(dataset_dir_train_mat))
    #input()
...
def val_plot_confusion_matrix(cfm,epoch):
    ...
    #cfm_plot = sn.heatmap(df_cfm, annot=True)
    cfm_plot = sns.heatmap(df_cfm, cmap='coolwarm', annot=True, fmt=".1f")
    #print('dataset val mat path ',str(dataset_dir_val_mat))
    #input()
...
def test_plot_confusion_matrix(cfm):
    ...
    #print('dataset test mat path ',str(dataset_dir_test_mat))
    #input()
...
class CustomDataset_train(Dataset):
    def __init__(self):
        ...
        #print('data set path is ',self.data_path)
        #input()
    ...
    def __getitem__(self, idx):
        ...
        #fused_tensor_data = fused_tensor_data.unsqueeze(dim=0)
        
        #fused_tensor_data=self.transform(fused_tensor_data)
        
        
        #fused_tensor_data=torch.squeeze(fused_tensor_data)
        print('after transform train',fused_tensor_data.size())
        #input()
...
class CustomDataset_val(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        print('val size',fused_tensor_data.size())
        #input()
        return (fused_tensor_data, class_id)
...
class CustomDataset_test(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        print('fused data test ',fused_tensor_data.size())
        #input()
        return (fused_tensor_data, class_id)
...
def train(model, optimizer, train_loader, epoch,writer):
        ...
        for data, target in train_loader:    
            #target2 = torch.sparse.torch.eye(12).index_select(dim=0, index=target) 
            ...
            if use_cuda:    
                ...
                #print('show time data shape training is ',data.size())
                #input()
                #input()
                #input()
                #input()
            ...
            #loss2 = criterion(output,target).data
            
            #print('loss 1 is ',loss)
            #print()
            #print('loss 2 is ',loss2)
            #input()
            optimizer.zero_grad()
            loss.backward()
            optimizer.step()
        ...
        #print('train report',train_report_file)
        #input()
        ...
        with torch.no_grad():
            ...
            for data, target in val_loader:
                ...
                if use_cuda:    
                    ...
                    data=data.float()
                    #print('target',target)
                    #print('data shape in validation ',data.size())
                    #input()
            ...
            #input()
                ...
                loss=criterion(output,target)
                #print('val loss for this batch is ',loss)
            ...
            #print('val report file ',val_report_file)
...
if __name__ == '__main__':
 for loso_split in LOSO_run:
  #if loso_split=='LOSO7':   
  #    run=4
  #if loso_split=='LOSO8': 
  run=1
  while run<11:
    print('current loso split is ',loso_split)
    print()
    #print(str(loso_split))
    print()
    ...
    dataset_dir_train ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/dataset_filtred_"+str(loso_split)+"_15sec"+"/train_dataset_"+str(loso_split)+"_15sec_overlapping0.9/"


    dataset_dir_val ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/dataset_filtred_"+str(loso_split)+"_15sec"+"/val_dataset_"+str(loso_split)+"_15sec_overlapping0.9/"


    dataset_dir_test ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/dataset_filtred_"+str(loso_split)+"_15sec"+"/test_dataset_"+str(loso_split)+"_15sec_overlapping0.9/"
    
    ############################################
    
    
    dataset_dir_train_mat ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/"+str(loso_split)+"/15sec_filtred/train/run"+str(run)+"/"


    dataset_dir_val_mat ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/"+str(loso_split)+"/15sec_filtred/val/run"+str(run)+"/"


    dataset_dir_test_mat ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/"+str(loso_split)+"/15sec_filtred/test/run"+str(run)+"/"


    ################################################


    #performence_file='C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/'+str(loso_split)+'/15sec_overlapping0.9/'+'performances_UWB_classification1_'+str(loso_split)+'_15s_overlapping0.9_run'+str(run)+'.txt'
    
    train_report_file=dataset_dir_train_mat+'train_report_UWB_classification1_'+str(loso_split)+'_15s_filtred_run'+str(run)+'.txt'

    val_report_file=dataset_dir_val_mat+'val_report_UWB_classification1_'+str(loso_split)+'_15s_filtred_run'+str(run)+'.txt'

    test_report_file=dataset_dir_test_mat+'test_report_UWB_classification1_'+str(loso_split)+'_15s_filtred_run'+str(run)+'.txt'
...
#######################################################################################
    ...
    for epoch in range(1, 50):
        ...
        if val_accuracy> best_accuracy:
           ...
           torch.save(model.state_dict(), 'C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/'+str(loso_split)+'/15sec_filtred/test/run'+str(run)+'/model_15sec_filtred_'+str(loso_split)+'_clf1_run'+str(run)+'.pth')
...
####load the besrt state of the torch model and 
    ...
    model.load_state_dict(torch.load('C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/'+str(loso_split)+'/15sec_filtred/test/run'+str(run)+'/model_15sec_filtred_'+str(loso_split)+'_clf1_run'+str(run)+'.pth'))
