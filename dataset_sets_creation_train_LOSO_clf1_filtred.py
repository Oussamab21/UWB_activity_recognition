...
LOSO_run=['LOSO8','LOSO4','LOSO1']


#LOSO_run=['LOSO4','LOSO5','LOSO1']
...
if __name__ == '__main__':
 for loso_split in LOSO_run:
  ...
  while run<11:
    ...
    dataset_dir_train ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/dataset_filtred_"+str(loso_split)+"_5sec"+"/train_dataset_"+str(loso_split)+"_5sec_overlapping0.9/"


    dataset_dir_val ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/dataset_filtred_"+str(loso_split)+"_5sec"+"/val_dataset_"+str(loso_split)+"_5sec_overlapping0.9/"


    dataset_dir_test ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/dataset_filtred_"+str(loso_split)+"_5sec"+"/test_dataset_"+str(loso_split)+"_5sec_overlapping0.9/"
    
    ############################################
    
    
    dataset_dir_train_mat ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/"+str(loso_split)+"/5sec_filtred/train/run"+str(run)+"/"


    dataset_dir_val_mat ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/"+str(loso_split)+"/5sec_filtred/val/run"+str(run)+"/"


    dataset_dir_test_mat ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/"+str(loso_split)+"/5sec_filtred/test/run"+str(run)+"/"
    ...
    train_report_file=dataset_dir_train_mat+'train_report_UWB_classification1_'+str(loso_split)+'_5s_filtred_run'+str(run)+'.txt'

    val_report_file=dataset_dir_val_mat+'val_report_UWB_classification1_'+str(loso_split)+'_5s_filtred_run'+str(run)+'.txt'

    test_report_file=dataset_dir_test_mat+'test_report_UWB_classification1_'+str(loso_split)+'_5s_filtred_run'+str(run)+'.txt'
...
#######################################################################################
    ...
    for epoch in range(1, 50):
        ...
        if val_accuracy> best_accuracy:
           ...
           torch.save(model.state_dict(), 'C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/'+str(loso_split)+'/5sec_filtred/test/run'+str(run)+'/model_5sec_filtred_'+str(loso_split)+'_clf1_run'+str(run)+'.pth')
...
####load the besrt state of the torch model and 
    ...
    model.load_state_dict(torch.load('C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification1/'+str(loso_split)+'/5sec_filtred/test/run'+str(run)+'/model_5sec_filtred_'+str(loso_split)+'_clf1_run'+str(run)+'.pth'))
