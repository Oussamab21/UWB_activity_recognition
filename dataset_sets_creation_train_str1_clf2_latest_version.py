...
def train(model, optimizer, train_loader, epoch,writer):
        ...
        for data, target in train_loader:    
            ...
            if use_cuda:    
                ...
                #print('show time data shape is ',data.size())
                #input()
                #input()
                #input()
                #input()
...
if __name__ == '__main__':
  ...
  while run<11:  
    ...
    dataset_dir_train ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/train_dataset_str1_clf2_15sec_filtred/"


    dataset_dir_val ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/val_dataset_str1_clf2_15sec_filtred/"


    dataset_dir_test ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/test_dataset_str1_clf2_15sec_filtred/"


    ###########################################               ############################################     ###########

    dataset_dir_train_mat ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification2/str1/15sec_filtred/train/run"+str(run)+"/"


    dataset_dir_val_mat ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification2/str1/15sec_filtred/val/run"+str(run)+"/"


    dataset_dir_test_mat ="C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification2/str1/15sec_filtred/test/run"+str(run)+"/"


    #performence_file='C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification2/str1/10sec_filtred/'+"performances_UWB_classification2_str1_10s_filtred_run10.txt"


    train_report_file=dataset_dir_train_mat+'train_report_UWB_classification2_str1_15s_filtred_run'+str(run)+'.txt'

    val_report_file=dataset_dir_val_mat+'val_report_UWB_classification2_str1_15s_filtred_run'+str(run)+'.txt'

    test_report_file=dataset_dir_test_mat+'test_report_UWB_classification2_str1_15s_filtred_run'+str(run)+'.txt'
...
#######################################################################################
    ...
    for epoch in range(1, 50):
        ...
        if val_accuracy> best_accuracy:
           ...
           torch.save(model.state_dict(), 'C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification2/str1/15sec_filtred/test/run'+str(run)+'/model_15sec_filtred_str1_clf2_run'+str(run)+'.pth')
...
####load the besrt state of the torch model and 
    ...
    model.load_state_dict(torch.load('C:/Users/obouldjedr/Desktop/latest_dataset_liara/UWB/classification2/str1/15sec_filtred/test/run'+str(run)+'/model_15sec_filtred_str1_clf2_run'+str(run)+'.pth'))
