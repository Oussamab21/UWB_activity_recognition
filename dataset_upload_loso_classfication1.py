...
def get_liste_pers_current_dataset(current_pers_index):
    ...
    if len(train_pers_current_dataset)==9:    
                ...
                #with open(list_files_current_activity[j]) as file:
                    ...
                    for m in range(len(instances_UWB1_current_file)):
                        ...
                        if mode==1:
                                ...
                                savingpath=data_path+'/'+'dataset_LOSO_filtred'+str(dataset_index+1)+'_'+str(timestep)+'/train'+'_dataset_LOSO'+str(dataset_index+1)+'_'+timestep+'_overlapping'+str(overlapping_ratio)+'/'+current_activity+'/'+'data_'+str(data_count)+'.pickle'
                            
                        if mode==2:
                            
                                savingpath=data_path+'/'+'dataset_LOSO_filtred'+str(dataset_index+1)+'_'+str(timestep)+'/val'+'_dataset_LOSO'+str(dataset_index+1)+'_'+timestep+'_overlapping'+str(overlapping_ratio)+'/'+current_activity+'/'+'data_'+str(data_count)+'.pickle'
                            
                        if mode==3:
                            
                                savingpath=data_path+'/'+'dataset_LOSO_filtred'+str(dataset_index+1)+'_'+str(timestep)+'/test'+'_dataset_LOSO'+str(dataset_index+1)+'_'+timestep+'_overlapping'+str(overlapping_ratio)+'/'+current_activity+'/'+'data_'+str(data_count)+'.pickle'    
...
if __name__ == '__main__':
  ...
  for z in range (len(list_pers)): 
    ...
    #input()
    pers_lists_current_dataset=data_path+'/'+'dataset_LOSO'+str(z+1)+'_'+str(timestep_seconds)+'sec/pers_lists_current_dataset_LOSO'+str(z+1)+'_'+str(timestep_seconds)+'sec.txt'
    ...
    files_lists_current_dataset=data_path+'/'+'dataset_LOSO'+str(z+1)+'_'+str(timestep_seconds)+'sec/files_lists_current_dataset_LOSO'+str(z+1)+'_'+str(timestep_seconds)+'sec.txt'
